...
##      screen.blit(sprites[self.id % 4], (self.rect.x, self.rect.y))
  ...
  class Level_01(Level):
      ...
      def __init__(self, player):
          ...
          level = [[210, 70, 0, SCREEN_HEIGHT//2],
                   [210, 70, 500, 500],
                   [210, 70, 800, 400],
                   [210, 70, 1000, 500],
                   [210, 70, 1120, 280],
...
##  sprite4 = pygame.image.load('images/Tubby/Tubby_front.png')
  ...
  sprite1 = pygame.Surface((40,60))
  sprite1.fill((220,220,220))
  sprite2 = pygame.Surface((40,60))
  sprite2.fill((169,169,169))
  sprite3 = pygame.Surface((40,60))
  sprite3.fill((105,105,105))
  sprite4 = pygame.Surface((40,60))
  sprite4.fill((112,128,114))
  ...
  try:
    ...
    print("Failed to find running server, fellback onoto singleplayer.")
    import singleplayer
    singleplayer.main()
